        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-3xl mx-auto">
            <div className="text-center">
              <div className="text-3xl font-bold text-neon-orange mb-2">6</div>
            ...
            <div className="text-center">
              <div className="text-3xl font-bold text-neon-purple mb-2">2FA</div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {oauthProviders.map((provider) => {
              ...
              return (
                <Card key={provider.id} className="bg-dark-700 border-dark-600 hover:border-neon-orange/50 transition-all">
                  <CardHeader>
                    <div className="flex items-center justify-between mb-4">
                      <div className={`w-12 h-12 bg-${provider.color}-600/20 rounded-lg flex items-center justify-center`}>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      <div>
                        ...
                        <div className="flex flex-wrap gap-1">
                          {provider.scopes.map((scope) => (
                            <Badge key={scope} variant="outline" className="text-xs border-gray-600 text-gray-300">
                              {scope}
                            </Badge>
                          ))}
                        </div>
                      ...
                      <Button 
                        ...
                        className={`w-full ${isConnected ? 'bg-green-600/20 text-green-400' : 'flame-gradient text-dark-900 font-semibold'}`}
                      >
